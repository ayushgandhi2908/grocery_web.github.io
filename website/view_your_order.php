...
<body>
  ...
  $sql = "SELECT * FROM admin_orders where sno = '$vi' ORDER BY sno DESC";
  ...
  if($num_rows > 0){
    ...
    while($rows = mysqli_fetch_assoc($result)){
      ...
      echo '<div class="col-12 col-sm-12 col-md-6 col-lg-4 my-3 ">
      <div id="purhcase_card">
          <img src="/food planet /admin/Food_image/'.$food_image.'" class="purchase_card_image" alt="...">
           <div class="card-body">
               ...
               <p class="card-text mt-3"> '.$txn_date.'</p>
               ...
               <b><p class="card-text mt-3">Quantity: '.$food_no_of_plates.'</p></b>
               <b><p class="card-text mt-3">Price :'.$txn_amt.'$ </p></b>';
               if($bank_name != "Null"){
                  echo '<b><p class="card-text mt-3">Bank : '.$bank_name.'</p></b>
                  <b><p class="card-text mt-3">Gateway : '.$gateway.'</p></b>';
                }
              echo '
            </div>
        </div>
      ...
      // echo '
      // <div id="your_order_box2">
      // <img class="view_your_order_img" src= "/food planet/admin/Food_Image/'.$food_image.'">
      // <div class="order_dply_block2">
      // <h6><b>Payment Type:</b> '.$payment_type.'</h6>
      // <h6><b>Order ID:</b> '.$order_id.'</h6>
      // <h6><b>Cust ID:</b> #'.$user_cust_id.'</h6>
      // <h6><b>Food Name:</b> '.$food_name.'</h6>
      // <h6><b>Quantity:</b> '.$food_no_of_plates.'</h6>
      // <h6><b>Txn_Amount:</b> '.$txn_amt.'Rs</h6>';
        
      // if($bank_name != "Null"){
      //   echo '<h6><b>Bank:</b> '.$bank_name.'</h6>
      // <h6><b>GateWay:</b> '.$gateway.'</h6>';
      // }
      

      // echo '<button class="my-2 btn btn-primary" disabled>Status: '.$order_status.'</button><br>
      // <button class="mb-2 btn btn-primary" disabled>TXN Status: '.$txn_status.'</button><br>';
      // if($order_status =="pending"){
      //   echo '<a href="your_order.php?cancel_id='.$cancel_id.'"><button class="btn btn-primary">Cancel Order</button></a>';
      // }
